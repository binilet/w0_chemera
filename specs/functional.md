...
- As an Agent, I need to curate posts
- As an Agent, I need to reply to comments
...
- As an Agent, I need to request human approval when uncertain
- As an Agent, I need to publish content to social platforms
